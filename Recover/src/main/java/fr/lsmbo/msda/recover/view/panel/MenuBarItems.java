...
public class MenuBarItems extends MenuBar {
	...
	public MenuBarItems() {
		...
		System.out.println(IconRessource.LOAD);
//		Image openIcon = new Image(getClass().getResourceAsStream(IconRessource.LOAD));
//		ImageView imageView = new ImageView(openIcon);
