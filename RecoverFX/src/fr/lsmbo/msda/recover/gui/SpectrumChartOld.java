...
//// DataSeries series2 = new DataSeries("Fragments below low intensity
// threshold", data2);
//// DataSeries series3 = new DataSeries("Fragments", data3);
//// DataSeries series4 = new DataSeries("Fragments above high intensity
// threshold", data4);
////
//// // create the plot
...
////
////// plot.setBounds(0, Session.HIGHEST_FRAGMENT_MZ, 0,
// Session.HIGHEST_FRAGMENT_INTENSITY);
////
//// // return full plot
//// return plot;
//// }
...
//
// // create the plot
// JFreeChart chart = ChartFactory.createXYBarChart(spectrum.getTitle(), "M/z",
// false, "Intensity", dataset);
//
// // add some styling
//// plot.setInsets(new Insets2D.Double(20, 60, 60, 40));
//// plot.getPointRenderers(series1).get(0).setColor(Color.RED);
...
//// domain.setRange(0.00, Session.USE_FIXED_AXIS ? Session.HIGHEST_FRAGMENT_MZ
// : spectrum.getFragmentMaxMoz());
////// domain.setTickUnit(new NumberTickUnit(0.1));
//// domain.setVerticalTickLabels(true);
//// NumberAxis range = (NumberAxis) plot.getRangeAxis();
//// range.setRange(0.00, Session.USE_FIXED_AXIS ?
// Session.HIGHEST_FRAGMENT_INTENSITY : spectrum.getFragmentMaxIntensity());
...
// realValue = xAxis ? Session.HIGHEST_FRAGMENT_MZ :
// Session.HIGHEST_FRAGMENT_INTENSITY;
// }
...
// return ((int)n + 0.5) * divider; // case 1: value=2410.14553 =>
// ((int)2.41014553 + 0.5) = 2 + 0.5 = 2.5
// } else {
// return ((int)n + 1) * divider; // case 2: value=775.657 => ((int)7.75657 + 1)
// = 7 + 1 = 8
// }
// }
//
